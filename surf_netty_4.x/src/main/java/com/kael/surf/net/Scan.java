...
//		return Class.forName(claName);
	...
	public static void main(String[] args) throws Exception {
		final Set<Class<?>> clazzes = getClasses("com.kael");
		
		for(Class<?> c : clazzes){
			if(c.isAnnotationPresent(Cmd.class)){
//				Cmd cmd = c.getAnnotation(Cmd.class);
//				System.out.println(c.getName()+","+cmd.code()+","+cmd.protoName());
			}else if(GeneratedMessage.class.isAssignableFrom(c)){
...
//					System.out.println(field.getShort(obj)+"=="+field.getName()+","+resp.protoName());
//			}
//		}
